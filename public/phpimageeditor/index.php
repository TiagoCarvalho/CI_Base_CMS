...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
	    ...
	    <script type="text/javascript" src="javascript/jquery-ui-1.7.3.custom.min.js"></script>
        
        <script type="text/javascript" src="lite/javascript/phpimageeditor.js"></script>
					...
					<div class="tabs">
						...
						<div id="actionContainer">
									...
									<tr>
										...
										<td>
												...
												<div class="notification attention png_bg">
													<div> <?php PIE_Echo($objPHPImageEditor->texts["RESIZE HELP"]); ?> </div>
												</div>
							...
							<div id="panel_<?php PIE_Echo(MENU_ROTATE); ?>" class="panel">
								<div class="field">
									<input class="button" id="btnRotateLeft" type="button" value="<?php PIE_Echo($objPHPImageEditor->texts["LEFT 90 DEGREES"]); ?>"/>
									<input class="button" id="btnRotateRight" type="button" value="<?php PIE_Echo($objPHPImageEditor->texts["RIGHT 90 DEGREES"]); ?>"/>
							...
							<div id="panel_<?php PIE_Echo(MENU_CROP); ?>" class="panel">
								<div class="field">
									...
									<div class="notification attention png_bg">
										<div> <?php PIE_Echo($objPHPImageEditor->texts["INSTRUCTIONS"]); ?><br/>
											 <?php PIE_Echo($objPHPImageEditor->texts["CROP HELP"]); ?></div>
									</div>
										
								</div>
								<div class="field crop-settings">
									<div class="notification information png_bg">
										<div> <?php PIE_Echo($objPHPImageEditor->texts["CROP WIDTH"]); ?>: <span id="cropwidth">0</span>
										<?php PIE_Echo($objPHPImageEditor->texts["CROP HEIGHT"]); ?>: <span id="cropheight">0</span></div>
									</div>
						...
						<div class="main-actions">
							<input type="button" class="button" id="btnupdate" name="btnupdate" value="<?php PIE_Echo($objPHPImageEditor->texts["UPDATE"]); ?>"/>
